...
health_check.py HTTPS endpoints            01:47 snapshot, UI/API 200
health_check.py SSH runtime                01:47 snapshot, services active, active_papers=30, chunks=1934, index_fresh=True, retrieval/admin metrics smokes OK
```
