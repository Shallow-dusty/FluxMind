...
def main() -> int:
    ...
    check(
        "Deployed source baseline       4f27651 fix: exclude coverage data from deploy sync" in repo_status
        and "Deployment record follow-up    this docs refresh after 2026-06-15 08:21 live verification"
        in repo_status,
