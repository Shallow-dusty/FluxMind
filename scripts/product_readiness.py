#!/usr/bin/env python3
"""Run the no-secret FluxMind productization readiness check."""
...
from src.product_readiness import (  # noqa: E402
...
def main() -> int:
    ...
    parser.add_argument(
        "--require-activation",
        action="store_true",
        help="Exit nonzero unless identity, quota, and billing activation targets are ready.",
    )
    ...
    try:
        ...
        if args.format == "markdown":
            output = format_product_readiness_markdown(status) + "\n"
        else:
