#!/usr/bin/env python3
"""Run the no-secret FluxMind collaboration readiness check."""
...
from src.collaboration_readiness import (  # noqa: E402
...
def main() -> int:
    ...
    parser.add_argument(
        "--require-activation",
        action="store_true",
        help="Exit nonzero unless private-corpus and share-link activation gates are ready.",
    )
    ...
    try:
        ...
        if args.format == "markdown":
            output = format_collaboration_readiness_markdown(status) + "\n"
        else:
