    ...
    return (
        RuntimeGroupSpec(
            ...
            known_files=(
                ...
                RuntimeFileSpec("api_key_registry_sqlite", metadata_dir / "api_keys.sqlite3"),
                RuntimeFileSpec("product_registry_sqlite", metadata_dir / "product_registry.sqlite3"),
                RuntimeFileSpec("share_link_registry_sqlite", metadata_dir / "share_links.sqlite3"),
